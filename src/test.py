...
############################################################################################################################################################
    ...
    def main():
        ...
        for i in range(0, obsNumber):
            posObstRobot_pub[i] = rospy.Publisher('gazebo/set_model_state', ModelState, queue_size = 10)
        ...
        for e in range(num_episodes):
            ...
            while not done:
                ...
                if done:
                    posObstRobot_msg.pose.position.x = initPosMainRobot[0] + obstacleRadius + agentRadius + random.randrange(0, 1000)/100
                    posObstRobot_msg.pose.position.y = initPosMainRobot[1] + obstacleRadius + agentRadius + random.randrange(0, 1000)/100
