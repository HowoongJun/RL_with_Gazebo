...
class A2CAgent:
    def __init__(self, state_size, action_size):
        ...
        if self.load_model1:
            self.actor.load_weights("/home/howoongjun/catkin_ws/src/simple_create/src/DataSave/backup/Actor_For.h5")
            self.critic.load_weights("/home/howoongjun/catkin_ws/src/simple_create/src/DataSave/backup/Critic_For.h5")

        if self.load_model2:
            self.actor.load_weights("/home/howoongjun/catkin_ws/src/simple_create/src/DataSave/Actor_For_Macro.h5")
            self.critic.load_weights("/home/howoongjun/catkin_ws/src/simple_create/src/DataSave/Critic_For_Macro.h5")
...
def main():
    ...
    for e in range(num_episodes):
        ...
        while not done:
            ...
            tmpAction = tmpAction * np.asarray(1 - policyArr)
            ...
            rate.sleep()
        if e % 50 == 0:
            agent.actor.save_weights("/home/howoongjun/catkin_ws/src/simple_create/src/DataSave/Actor_For_Macro.h5")
            agent.critic.save_weights("/home/howoongjun/catkin_ws/src/simple_create/src/DataSave/Critic_For_Macro.h5")
